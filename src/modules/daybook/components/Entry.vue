<template>
  <div class="entry-container mb-3 pointer p-2" @click="$router.push( { name:'entry', params: { id:10 } })" >
    ...
    <div class="entry-description">
        ...
        Hic asperiores molestias delectus, perspiciatis veniam saepe, praesentium quam itaque unde, vero nesciunt! 
        Accusamus iste iusto deleniti rerum provident officiis ea beatae!
    </div>
  </div>
</template>
